...
// app.use(cors({ origin: ['http://localhost:5173', 'http://127.0.0.1:5173', 'http://localhost:5174', 'http://127.0.0.1:5174,', 'https://smart-ai-back-end.onrender.com' ] }));
app.use(cors({
  origin: 'https://smart-ai-back-end.onrender.com',
  credentials: true
}));
